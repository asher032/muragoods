...
export default function ChangelogPage() {
  return (
    <div style={{ maxWidth: 640, margin: '0 auto', padding: '32px 20px 64px' }}>
      <h1 style={{ fontFamily: 'var(--font-arcade)', fontSize: 20, color: 'var(--ms-text)', margin: '0 0 6px', letterSpacing: '0.06em' }}>
        MURASTREAM CHANGELOG
      </h1>
      <p style={{ fontSize: 13, color: 'var(--ms-text-dim)', margin: '0 0 32px' }}>
      ...
      <div style={{ position: 'relative', paddingLeft: 24 }}>
        ...
        {CHANGELOG.map((entry) => (
          <section key={entry.id} style={{ position: 'relative', marginBottom: 36 }}>
            ...
            <p style={{ fontSize: 15, fontWeight: 600, color: 'var(--ms-text)', margin: '6px 0 12px' }}>{entry.title}</p>
