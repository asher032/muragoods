...
export const MODULES: ModuleDef[] = [
  // ─── 🎵 Music ────────────────────────────────────────────────────────────
  {
    ...
    fields: [
      ...
      m('music.voiceChannelId', 'Music Voice Channel', 'channel', { icon: '🔊', default: '' }),
      m('music.textChannelId', 'Music Text Channel', 'channel', { icon: '💬', default: '' }),
      ...
      m('music.maxVolume', 'Maximum Volume', 'number', { default: 150, help: 'Caps the volume slider (10 – 150)' }),
      m('music.defaultLoop', 'Default Loop Mode', 'select', {
        default: 'off',
        options: [
          { value: 'off', label: 'Off' },
      ...
      m('music.enableNowPlaying', 'Now Playing Message', 'toggle', { default: true }),
      m('music.maxQueueSize', 'Max Queue Size', 'number', { default: 100, help: 'Max songs queued' }),
