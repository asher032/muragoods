      ...
      <div style={{ minHeight: '100vh', background: '#0A0A0A', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px' }}>
        <div style={{ textAlign: 'center', maxWidth: '400px' }}>
          ...
          <button onClick={() => window.location.reload()} style={{
            padding: '10px 24px', borderRadius: '8px', border: '1px solid rgba(184,92,255,0.3)',
        ...
        <div style={{
          ...
          <div style={{ textAlign: 'center', marginBottom: '32px' }}>
            <div style={{
              ...
              background: 'rgba(184,92,255,0.15)', border: '1px solid rgba(184,92,255,0.25)',
              display: 'flex', alignItems: 'center', justifyContent: 'center',
              margin: '0 auto 16px',
            }}>
              <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="#B85CFF" viewBox="0 0 1024 1024">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button type="submit" disabled={loading} style={{
              ...
              background: '#B85CFF', color: '#FFF', cursor: loading ? 'not-allowed' : 'pointer',
