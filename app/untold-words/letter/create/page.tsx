      ...
      <main style={{ minHeight: '100vh', background: '#0a0a18' }}>
        ...
        <div style={{ minHeight: '90vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '80px 20px' }}>
          <div style={{ textAlign: 'center', maxWidth: '480px', width: '100%' }}>
            ...
            <h1 style={{ fontFamily: 'var(--font-arcade)', fontSize: '22px', color: '#ffd60a', marginBottom: '12px' }}>Your letter is ready!</h1>
            ...
            <div style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '12px', padding: '16px', marginBottom: '20px', wordBreak: 'break-all' }}>
              <p style={{ fontFamily: 'var(--font-arcade)', fontSize: '11px', color: '#ffb4a2' }}>{link}</p>
            </div>

            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', marginBottom: '24px' }}>
              <button onClick={() => navigator.clipboard.writeText(link)} style={{ width: '100%', padding: '14px', borderRadius: '12px', border: '1px solid rgba(255,100,150,0.4)', background: 'rgba(255,100,150,0.12)', color: '#ffb4a2', fontFamily: 'var(--font-arcade)', fontSize: '11px', cursor: 'pointer' }}>
                📋 COPY LINK
              </button>
              <button onClick={() => {
                const subject = encodeURIComponent('You have a letter waiting for you 💌');
                const body = encodeURIComponent(`Hey ${recipientName},\n\nSomeone wrote you a letter. Open the link below to read it:\n\n${link}\n\n— Sent via Muragoods Untold Words`);
                window.open(`https://mail.google.com/mail/?view=cm&to=&subject=${subject}&body=${body}`, '_blank');
              }} style={{ width: '100%', padding: '14px', borderRadius: '12px', border: '1px solid rgba(255,180,100,0.4)', background: 'rgba(255,180,100,0.12)', color: '#ffb464', fontFamily: 'var(--font-arcade)', fontSize: '11px', cursor: 'pointer' }}>
                ✉️ SEND VIA GMAIL
              </button>
            </div>
